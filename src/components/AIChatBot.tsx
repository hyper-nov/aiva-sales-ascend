...
const AIChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    { type: 'bot', text: 'Привет! Я помогу вам узнать больше о AIVA. Задайте любой вопрос!' }
  ]);
    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          ...
          className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse"
        >
          {isOpen ? (
